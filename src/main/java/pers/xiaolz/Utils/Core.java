...
public class Core {
	 ...
	 */
	public static void
	sendGroupMessagesPicText(long selfQQ,long fromGroup,String msg,int anonymous){
		try {
			JSONObject json = new JSONObject();
			json.put("type", 203);
			json.put("selfQQ", selfQQ);
			...
			System.out.println("Core.sendGroupMessagesPicText:"+e);
		}
	}
	 ...
	 * @param fromQQ	上传好友图片时为好友QQ 上传群图片时为群号
	 ...
	 * 获取机器人Pskey
	 * @param selfQQ
	 * @param field		域		tenpay.com;openmobile.qq.com;docs.qq.com;connect.qq.com;qzone.qq.com;
